...
func (x *IsEvenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsEvenRequest) ProtoMessage() {}

func (x *IsEvenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protos_service_proto_msgTypes[0]
...
// Deprecated: Use IsEvenRequest.ProtoReflect.Descriptor instead.
func (*IsEvenRequest) Descriptor() ([]byte, []int) {
	return file_protos_service_proto_rawDescGZIP(), []int{0}
}

func (x *IsEvenRequest) GetInteger() int32 {
	if x != nil {
		return x.Integer
	}
	return 0
...
type IsEvenReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IsEven bool `protobuf:"varint,1,opt,name=isEven,proto3" json:"isEven,omitempty"`
}

func (x *IsEvenReply) Reset() {
	*x = IsEvenReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *IsEvenReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsEvenReply) ProtoMessage() {}

func (x *IsEvenReply) ProtoReflect() protoreflect.Message {
	mi := &file_protos_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsEvenReply.ProtoReflect.Descriptor instead.
func (*IsEvenReply) Descriptor() ([]byte, []int) {
	return file_protos_service_proto_rawDescGZIP(), []int{1}
}

func (x *IsEvenReply) GetIsEven() bool {
	if x != nil {
		return x.IsEven
	}
	return false
...
var file_protos_service_proto_rawDesc = []byte{
	...
	,
...
var file_protos_service_proto_goTypes = []interface{}{
	(*IsEvenRequest)(nil), // 0: helloworld.IsEvenRequest
	(*IsEvenReply)(nil),   // 1: helloworld.IsEvenReply
}
var file_protos_service_proto_depIdxs = []int32{
	0, // 0: helloworld.IsEvenService.IsEven:input_type -> helloworld.IsEvenRequest
	1, // 1: helloworld.IsEvenService.IsEven:output_type -> helloworld.IsEvenReply
